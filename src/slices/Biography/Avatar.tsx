...
export default function Avatar({ image, className }: AvatarProps) {
    ...
    return(
        <div ref={component} className={clsx("relative h-full w-full", className)}>
            ...
            <PrismicNextImage field={image} className="row-start-1 max-w-sm md:col-start-2 md:row-end-3" style={{ width: '400px', height: '380px', objectFit: 'cover', transition: "transform" }} 
            imgixParams={{ q:90 }}
            />
